...
import models.CurrentForecastResponse;
...
public class App extends AbstractVerticle {
  ...
  public static void main(String[] args) {
    ...
    vertx.fileSystem().readFile("C:\\Users\\YOS17\\OneDrive\\שולחן העבודה\\vertx.first offer\\vertxProj\\src\\main\\java\\resources\\city.list.json", result -> {
      if(result.succeeded()) {
